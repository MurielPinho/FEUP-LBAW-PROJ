...
<html>
  ...
  <div class="steps-form">
      <div class="steps-row setup-panel">
        ...
        <div class="steps-step">
          <a type="button" class="btn btn-warning btn-circle" disabled="disabled">4</a>
          <h6>In Delivery</h6>
        </div>
        <div class="steps-step">
      ...
      <br>
      <br>
      <h4>It will arrive in 5 days on the following address:</h4>
      <h5>{{$user}},</h5>
      <h5>{{$addr->address}}, Nº {{$addr->door}},</h5>
      <h5>{{$addr->postalcard}}, {{$addr->city}}</h5>
    </div>
      
     
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
      <button onclick="location.href='{{ url('/review') }}'" class="btn btn-primary me-md-2 btn-lg mt-2" type="button">Next</button>
    </div>
