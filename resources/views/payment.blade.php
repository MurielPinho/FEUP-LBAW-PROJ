...
<html>
  ...
  <div class="steps-form">
      <div class="steps-row setup-panel">
        ...
        <div class="steps-step">
          <a type="button" class="btn btn-warning btn-circle" disabled="disabled">3</a>
          <h6>Pay</h6>
        </div>
        <div class="steps-step">
    ...
    <br>
      ...
      <br>
    <div class="d-flex justify-content-center">
      <h4>The order will be shipped as soon as possible.</h4>
    </div>
       

    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
      <button onclick="location.href='{{ url('/delivery') }}'" class="btn btn-primary me-md-2 btn-lg mt-2" type="button">Next</button>
    </div>
