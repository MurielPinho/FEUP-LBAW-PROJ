...
<html>
  ...
  <body>
        ...
        <div class="col">
            ...
            <form class="px-4 py-3">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="Localidade">
                </div>
                <div class="mb-3">
                  <label for="exampleDropdownFormEmail1" class="form-label">Morada</label>
                  <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="Morada">
                </div>
                <div class="row row-cols-1 row-cols-md-2 g-4">
                  <div class="col">
                    <div class="mb-3">
                      <label for="exampleDropdownFormEmail1" class="form-label">Código Postal</label>
                      <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="XXXX-XXX">
                    </div>
                  </div>
                  <div class="col">
                    <div class="mb-3">
                      <label for="exampleDropdownFormEmail1" class="form-label">Andar</label>
                      <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="Andar">
                    </div>
                  </div>
                </div>
            </form>
            ...
            <form class="px-4 py-3">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="XXXXXXXXXXXXX">
              </div>
              <div class="row row-cols-1 row-cols-md-2 g-4">
                <div class="col">
                  <div class="mb-3">
                    <label for="exampleDropdownFormEmail1" class="form-label">CVV</label>
                    <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="YYY">
                  </div>
                </div>
                <div class="col">
                  <div class="mb-3">
                    <label for="exampleDropdownFormEmail1" class="form-label">Expiration Date</label>
                    <input type="text" class="form-control" id="exampleDropdownFormEmail1" placeholder="ZZ-ZZ-ZZZZ">
                  </div>
                </div>
              </div>
              </form>
    ...
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
      <button class="btn btn-primary me-md-2 btn-lg" type="button">Save Changes</button>
    </div>
